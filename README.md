...
> No secrets file yet? The app also lets you paste a Groq API key directly
> into the sidebar for the current session — handy for a quick test.
...
- **Bring-your-own-key mode** if you don't want to use Streamlit secrets
