...
with st.sidebar:
    ...
    st.markdown(styles.stage_sidebar_html(STEPS, st.session_state.step),
                unsafe_allow_html=True)
    ...
    st.session_state.model = st.selectbox(
        ...
        format_func=lambda m: "Llama 3.3 70B (quality)" if "70b" in m
        else "Llama 3.1 8B (fast)",
    )
    key_in_secrets = engine.get_api_key() is not None
    if not key_in_secrets:
        st.session_state.user_api_key = st.text_input(
            "Groq API key", type="password",
            help="Get a free key at console.groq.com. Stored only in this "
...
# ==========================================================================
    ...
    st.subheader("2 · Candidate & job profiles")
...
# ==========================================================================
    ...
    st.subheader("3 · Information check")
...
# ==========================================================================
    ...
    st.subheader("4 · Job match analysis")
    ...
    with col1:
        st.markdown(f'<div class="score-block"><div class="num">{match.get("match_score","—")}</div>'
...
# ==========================================================================
    ...
    st.subheader("5 · Interview risk engine")
...
# ==========================================================================
    ...
    st.subheader("6 · Question engine")
...
# ==========================================================================
    ...
    st.subheader("7 · Question priority")
...
# ==========================================================================
    ...
    st.subheader("8 · Answer blueprint")
    prio_map = {p["id"]: p["priority"] for p in data["priorities"].get("priorities", [])}
...
# ==========================================================================
    ...
    st.subheader("9 · Tough question coach")
    flat = data.get("_flat_questions", [])
...
# ==========================================================================
    ...
    st.subheader("10 · Battle plan & Forge Score")
    ...
    for col, (key, label) in zip(cols, labels):
        with col:
            st.markdown(f'<div class="score-block"><div class="num">{score.get(key,"—")}</div>'
...
# ==========================================================================
    ...
    st.subheader("11 · Practice & refine loop")
